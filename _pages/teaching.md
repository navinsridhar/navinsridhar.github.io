...
calculation, or the simulation) can actually succeed at it.

Three commitments shape how I run a classroom, a research group, or a one-on-one
mentorship.
...
one of the most rigorous and well-studied programs in the country for turning
active scientists into intentional teachers. Through ISEE PDP I designed and
delivered an inquiry activity on statistics at UCLA (2019), completed Columbia
CTL's advanced-track Teaching Development Program (TDP, 2018–2024), and Columbia
...
Mentorship is a structural commitment. I write down what I expect from a
student, I write down what they can expect from me, and we revisit both on a
set cadence. I look for students at the beginning of their trajectory — summer
undergraduates, Masters students, early PhDs — because that is the moment when
a generous, well-scaffolded first project changes an entire career.

I have now mentored **nine students** across four institutions (IISER Kolkata,
Pune University / Heidelberg / MPA-Garching, Columbia, Stanford, San Diego State,
Kyoto). Several have gone on to PhDs (UC San Diego, Stanford, MPA-Garching), and
...
The deliverable of a class is not an exam but a habit of mind. I treat every
course I teach — Intro to Astronomy labs at Columbia (Fall 2019, Spring 2020),
guest lectures, YYGS, outreach lectures at IISER Bhopal, TIFR Mumbai,
Columbia's SA-Columbia outreach program (≈ 750 high-school students), and my
mentorship of Democracy Prep High School students in computer science — as an
opportunity for students to pick up tools they will still be using ten years
later: how to formulate a question, how to read a paper, how to estimate an
order of magnitude, how to fail gracefully at a calculation and try again.
