...
<div class="row align-items-center mb-3">
  <div class="col-md-4 mb-3 mb-md-0">
    {% include figure.liquid path="assets/img/research/corona-reconnection.svg" class="img-fluid rounded z-depth-1" zoomable=true alt="Black-hole jet sheath and reconnection plasmoids" %}
  </div>
  <div class="col-md-8">
...
<div class="row align-items-center mb-3">
  <div class="col-md-4 mb-3 mb-md-0">
    {% include figure.liquid path="assets/img/research/frb-hypernebula.svg" class="img-fluid rounded z-depth-1" zoomable=true alt="Hypernebula around an FRB engine" %}
  </div>
  <div class="col-md-8">
...
<div class="row align-items-center mb-3">
  <div class="col-md-4 mb-3 mb-md-0">
    {% include figure.liquid path="assets/img/research/merger-precursor.svg" class="img-fluid rounded z-depth-1" zoomable=true alt="Shock-powered radio precursor of a NS–NS merger" %}
  </div>
  <div class="col-md-8">
